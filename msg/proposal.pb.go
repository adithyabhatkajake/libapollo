...
type ProtoProp struct {
	...
	Blk *chain.ProtoBlock `protobuf:"bytes,1,opt,name=Blk,proto3" json:"Blk,omitempty"`
}

func (x *ProtoProp) Reset() {
	*x = ProtoProp{}
...
func (x *ProtoProp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProtoProp) ProtoMessage() {}

func (x *ProtoProp) ProtoReflect() protoreflect.Message {
	mi := &file_msg_proposal_proto_msgTypes[0]
...
// Deprecated: Use ProtoProp.ProtoReflect.Descriptor instead.
func (*ProtoProp) Descriptor() ([]byte, []int) {
	return file_msg_proposal_proto_rawDescGZIP(), []int{0}
}

func (x *ProtoProp) GetBlk() *chain.ProtoBlock {
	if x != nil {
		return x.Blk
	}
	return nil
...
var file_msg_proposal_proto_rawDesc = []byte{
	...
	0x2f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x30, 0x0a, 0x09,
	0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x72, 0x6f, 0x70, 0x12, 0x23, 0x0a, 0x03, 0x42, 0x6c, 0x6b,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x50,
	0x72, 0x6f, 0x74, 0x6f, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x03, 0x42, 0x6c, 0x6b, 0x42, 0x2c,
	...
	0x69, 0x62, 0x61, 0x70, 0x6f, 0x6c, 0x6c, 0x6f, 0x2f, 0x6d, 0x73, 0x67, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
